      ...
      <section className="bg-white py-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-12">
            <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-primary mb-3">Kitchen Services</p>
            <h2 className="font-display text-3xl md:text-4xl font-bold text-gray-900 tracking-tight leading-[1.1] mb-3">What We Offer</h2>
            <p className="text-gray-500 font-light max-w-2xl mx-auto leading-relaxed">A complete kitchen transformation handled by specialists in every trade — no subcontractor juggling required.</p>
          </div>
